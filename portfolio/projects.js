...
const PROJECTS_DATA = [
    ...
    {
        id: 2,
        title: "نموذج تحليل تكاليف التشغيل والتخزين",
        description: "تصميم وبناء نظام لوحات تفاعلية لربط وتتبع تكاليف تشغيل الصوامع والسعات التخزينية بشكل لحظي لرفع كفاءة إدارة المخزون وتحليل الفروقات المالية.",
        category: "data",
        tags: ["Power BI", "Power Query", "Data Modeling", "Excel Pivot"],
